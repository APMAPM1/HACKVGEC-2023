								...
								<div class="m-sm-4">
									...
									<form method="post" action="index.php" autocomplete="off">
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" id="usernameemail" name="usernameemail" placeholder="Enter your email" />
										</div>
										<div class="mb-3">
										...
										<div class="text-center mt-3">
											...
											<button type="submit" class="btn btn-lg btn-primary" name="submit" id="submit">Sign in</button>
										</div>
									</form>
